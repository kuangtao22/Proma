...
const EXEMPT_REASONS = {
  ...
  SLACK_IPC_CHANNELS: "ID 属于 Slack Bot/连接，不是 Agent 会话 ID；凭据与连接状态由 Slack 配置边界管理",
...
const RENDERER_HANDLER_POLICIES: Record<FullChannelKey, RendererHandlerPolicy> = {
  ...
  ...defineRendererHandlerPolicies('SLACK_IPC_CHANNELS', [
    'GET_CONFIG',
    'GET_MANIFEST',
    'GET_STATUS',
    'REMOVE_BOT',
    ...
    'STOP_BOT',
    'TEST_CONNECTION',
  ], { kind: 'exempt', reason: EXEMPT_REASONS.SLACK_IPC_CHANNELS }),
