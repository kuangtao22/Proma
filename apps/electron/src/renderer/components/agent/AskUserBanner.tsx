...
export function AskUserBanner({ sessionId, onStop }: AskUserBannerProps): React.ReactElement | null {
    ...
    <div className="ask-user-banner mx-4 mb-3 rounded-xl bg-card shadow-lg overflow-hidden animate-in slide-in-from-bottom-2 duration-200">
      ...
      <div className="px-4 pt-3 pb-2">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-foreground">DutyDeck Agent 需要你的输入</span>
