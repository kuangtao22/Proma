    ...
    <>
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-base leading-[1.7] text-neutral-600 md:text-lg">
          安排好时间后，只要 DutyDeck 是打开状态，就会在设定时间自动执行。
        </p>
      </div>
      ...
      <div className="mt-14 space-y-16 md:mt-16 md:space-y-20">
        <article className="grid gap-10 border-t border-[#151515]/15 pt-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-center">
          ...
          <div className="min-w-0">
            <div className="text-xs font-medium uppercase tracking-[0.18em] text-[#151515]">示例 01 · 安排</div>
            <h3 className="mt-3 text-2xl font-medium text-neutral-900 md:text-3xl">每天 09:00 检查昨天的代码</h3>
            <p className="mt-4 text-base leading-[1.7] text-neutral-600 md:text-lg">
              把任务设为每天定点 09:00，设定好频率/模型/绑定的项目/是否开启飞书通知等，并保持 DutyDeck 处于打开状态。
            </p>
            <div className="mt-5 border-l-2 border-[#151515]/35 pl-4">
              <div className="text-base font-medium text-[#151515]">这样告诉 Agent</div>
        ...
        <article className="grid gap-10 border-t border-[#151515]/15 pt-10 lg:grid-cols-[22rem_minmax(0,1fr)] lg:items-center">
          <div className="min-w-0 lg:order-1">
            <div className="text-xs font-medium uppercase tracking-[0.18em] text-[#151515]">示例 02 · 执行</div>
          ...
          <figure className="min-w-0 overflow-hidden rounded-lg bg-[#f4f5f6] shadow-[0_14px_30px_rgba(21,21,21,0.12)] lg:order-2">
        ...
        <article className="grid gap-10 border-t border-[#151515]/15 pt-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-center">
          ...
          <div className="min-w-0">
            <div className="text-xs font-medium uppercase tracking-[0.18em] text-[#151515]">示例 03 · 查看</div>
