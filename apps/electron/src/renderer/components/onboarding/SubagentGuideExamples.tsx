  ...
  return (
    <section className="border-t border-[#151515]/20 py-16 md:py-20">
      <div className="max-w-2xl">
        <div className="text-xs font-medium uppercase text-[#151515]">真实示例</div>
      ...
      <div className="mt-14 space-y-16 md:mt-16 md:space-y-20">
        <article className="grid gap-10 border-t border-[#151515]/15 pt-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-center">
          ...
          <div>
            <div className="text-xs font-medium uppercase text-[#151515]">示例 01 · 启动</div>
        ...
        <article className="grid gap-10 border-t border-[#151515]/15 pt-10 lg:grid-cols-[22rem_minmax(0,1fr)] lg:items-center">
          <div className="lg:order-1">
            <div className="text-xs font-medium uppercase text-[#151515]">示例 02 · 深入</div>
        ...
        <article className="grid gap-10 border-t border-[#151515]/15 pt-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-center">
          ...
          <div>
            <div className="text-xs font-medium uppercase text-[#151515]">示例 03 · 汇总</div>
