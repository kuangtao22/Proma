...
export function TabBar(): React.ReactElement {
  ...
  }, [setActiveTabId, setActiveView, setAutomationForm, tabs, agentSessions, setAppMode, setCurrentConversationId, setCurrentAgentSessionId, setCurrentAgentWorkspaceId, setUnviewedCompleted])
